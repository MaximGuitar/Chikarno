	...
	<div class="container">
		...
		<div class="content">
			<div class="content-text">
				...
				<p>Настоящее Положение о политике конфиденциальности (далее — Положение) является официальным документом <?php the_field('company-name', 'option'); ?>, зарегистрированного по адресу: <?php the_field('addres-company', 'option'); ?> (далее - «Оператор») и определяет порядок обработки и защиты информации о физических лицах (далее — «Пользователи»), пользующихся сервисами, информацией, услугами сайта, расположенного на доменном имени <?php the_field('site-name', 'option'); ?> (далее — Сайт).</p>
